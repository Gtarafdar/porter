...
- Activity **log settings**: choose which event types to record, how long to keep them, and max size
- Multi-select download (JSON/CSV) and delete with confirm warnings; delete all with acknowledgment
- Auto-prune by age + cap on write, boot, settings save, and Activity open
- Builds on 0.2.31 Remove Mac + Activity view
